...
public final class Task implements Model {
  ...
  private Task(String id, String title, String body, Temporal.DateTime dateCreated, TaskState state) {
    this.id = id;
    this.title = title;
    this.body = body;
  ...
  public static class Builder implements TitleStep, BuildStep {
    ...
    private Builder(String id, String title, String body, Temporal.DateTime dateCreated, TaskState state) {
      this.id = id;
      this.title = title;
      this.body = body;
      this.dateCreated = dateCreated;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String body, Temporal.DateTime dateCreated, TaskState state) {
      super(id, title, body, dateCreated, state);
      Objects.requireNonNull(title);
    }
